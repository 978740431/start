...
public class IcoTokenQuery {
	...
	public IcoTokenQuery() {}

	public IcoTokenQuery(String tokenName, String token, Long icoMoney, Long currentMoney, Long topHave, Long icoNumber ) {
	...
	public Integer getNeedPull() {
		return needPull;
	}

	public void setNeedPull(Integer needPull) {
